...
//import com.demo.abdulrahmanrudwan.demotest.nav_silde_Demo.menu.DrawerAdapter;
//import com.demo.abdulrahmanrudwan.demotest.nav_silde_Demo.menu.DrawerItem;
...
//List<RootTransformation>  list= new ArrayList<>();
//list.add(new YTranslationTransformation(100f));
//list.add(new ScaleTransformation(100f));
//
...
//                .addRootTransformation( new CompositeTransformation(list))
//                .inject();
//
...
//
//        RecyclerView list2 = findViewById(R.id.list);
